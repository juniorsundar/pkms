...
** Create Package
   ...
   inside the pre-existing workspace made [[file:~/Dropbox/neorg/org/org-roam/20240802232335-px4_ros_2_integration.org::*Download][here]]. First, navigate to the workspace root:
