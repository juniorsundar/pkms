...
- # Middleware
	...
	- ## MAVLink
		...
		- PX4 uses MAVLink to communicate with ground stations and apps built with {:$/technical/px4/mavsdk:}[MAVLink SDKs] such as {:$/technical/px4/px4:*** QGroundControl}[QGroundControl].
- # Development
