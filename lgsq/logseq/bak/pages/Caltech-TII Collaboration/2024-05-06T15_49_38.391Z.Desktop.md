...
- DONE Fourth meeting
- DOING Verify and validate if the position obtained from the FC's EKF is the same as the actual position of the drone in the simulation environment
  id:: 6633c7e4-1bb7-4a2a-87c6-1d85b1034088
  :LOGBOOK:
  CLOCK: [2024-05-06 Mon 09:36:05]
  :END:
- ___
- # Instructional
